...
## Analysis is done on model 1 with 4 mg/kg IV infusion dosing
## CAUTION: This chunk takes several hours to run
## You can uncomment and run the following line to load the saved data from a previous run used in 
## the manuscript then go directly to the plot block below to view results
#load("sobol_all_objects.RData")  #load results from previous run
...
# save
g <- grid.arrange(gp_sobol, ncol=1, nrow=2)
ggsave(file="../deliv/figS2.pdf", g, width=6, height=8)
